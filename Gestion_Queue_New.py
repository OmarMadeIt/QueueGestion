...
# Définition des identifiants du propriétaire
owner_username = "monusername"
owner_password = "monpassword"

# Vérification si l'utilisateur est le propriétaire
def is_owner(user_id):
    if "username" in user_id and "password" in user_id:
        if user_id["username"] == owner_username and user_id["password"] == owner_password:
            return True
    return False
...
# Affichage du bouton pour voir la liste des clients en attente pour le propriétaire
...
# Affichage de la liste des clients en
